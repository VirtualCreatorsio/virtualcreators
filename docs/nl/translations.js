...
const translations = {
  en: {
    ...
    brandIdentityDescription: "Distinctive visual systems that communicate your unique story",
    ...
    shareVision: "Share your vision with me...",
    ...
    philosophyTitle3: "Guide Me",
    philosophyItemTitle1: "Purpose-Driven Design",
    philosophyDesc1: "Every element serves a purpose. I create designs that are not just beautiful, but strategically crafted to achieve your business goals.",
    ...
    processDesc1: "I dive deep into understanding your business, goals, and audience to create a strategic foundation for success.",
    ...
    ctaTitle2: "Something",
    ctaTitle3: "Amazing?",
    ctaSubtitle: "Let me transform your vision into a digital reality that drives results and creates lasting impact.",
    ...
    blogSubtitle: "Tips, trends, and behind-the-scenes stories from my journey in web development and design.",
    firstPostTitle: "Welcome to My Blog: Behind the Scenes of VirtualCreators",
    ...
    firstPostPara2: "The world of <a href=\"../../index.html#services\">web development</a> moves incredibly fast. New technologies emerge, design trends evolve, and user expectations continue to rise. Through this blog, I want to document not just what I'm learning, but how I'm applying these insights to real projects.",
    firstPostHeading2: "What You Can Expect",
    firstPostPara3: "I'll be sharing a mix of content designed to be valuable whether you're a fellow developer, a <a href=\"../../index.html#services\">business owner looking to improve your digital presence</a>, or simply someone curious about the web development world.",
    ...
    firstPostPara4: "Every project I work on is guided by a simple principle: thoughtful <a href=\"../../index.html#services\">design and development</a> should serve both the user and the business. This means creating solutions that are not just visually appealing, but also performant, accessible, and aligned with strategic goals.",
    firstPostPara5: "I believe in the power of simplicity. The best solutions often come from understanding the core problem deeply and finding elegant ways to solve it. This approach has served me well in projects ranging from e-commerce platforms to community websites.",
    ...
    designTrendsPara1: "As we move deeper into 2025, the <a href=\"../../index.html#services\">web design landscape</a> continues to evolve at a breathtaking pace. New technologies, changing user behaviors, and emerging design philosophies are reshaping how we think about <a href=\"../../index.html#work\">digital experiences</a>. After working on numerous projects this year, I've identified the key trends that are not just making waves, but fundamentally changing how we approach web design.",
    ...
    designTrendsPara3: "I've implemented this approach in recent <a href=\"../../index.html#work\">client projects</a>, where we've achieved conversion rate improvements of up to 40% simply by removing visual noise and focusing on what truly matters to the user journey. You can read more about my <a href=\"my-first-post.html\">design philosophy and approach</a>.",
    ...
    aiImpactPara1: "The integration of artificial intelligence into <a href=\"../../index.html#services\">design and web development</a> is no longer a distant future—it's happening right now, and it's reshaping our industry in profound ways. As someone who has been experimenting with AI tools and workflows throughout 2025, I've witnessed firsthand how these technologies are not replacing creativity, but amplifying it in ways we never imagined possible.",
    aiImpactHeading1: "The Current AI Landscape in Design",
    aiImpactPara2: "Today's AI tools have evolved far beyond simple automation. We're seeing sophisticated systems that can understand design principles, generate contextually appropriate solutions, and even predict user behavior. What excites me most is how these tools are democratizing design while simultaneously pushing the boundaries of what's possible for experienced designers and developers. These developments are closely tied to <a href=\"web-design-trends.html\">the latest web design trends</a>.",
    ...
    aiImpactHeading3: "AI in My Development Workflow",
    aiImpactPara3: "In recent projects, I've integrated AI tools at various stages of the <a href=\"../../index.html#services\">development process</a>. For code generation, AI has become invaluable for creating boilerplate code, optimizing performance, and even suggesting accessibility improvements I might have overlooked. However, the real magic happens when AI assists with creative problem-solving rather than just automating repetitive tasks.",
    ...
    aiImpactPara6: "While the potential is enormous, integrating AI into design and development workflows isn't without challenges. Issues around originality, data privacy, and maintaining the human touch in digital experiences require careful consideration. I've found that the most successful AI integration happens when we maintain clear boundaries about where AI excels and where human creativity and empathy are irreplaceable.",
    aiImpactHeading6: "Best Practices I've Learned",
    aiImpactPara7: "Through experimentation and <a href=\"../../index.html#work\">client work</a>, I've developed several principles for effective AI integration: always validate AI suggestions against user needs, use AI to explore multiple design directions quickly, and maintain human oversight for final decisions. Most importantly, I've learned that AI works best when it's enhancing rather than replacing the fundamental human elements of design—empathy, cultural understanding, and creative intuition.",
    ...
    cookieAnalyticsDescription: "These cookies help me understand how visitors interact with my website by collecting and reporting information anonymously.",
    ...
    informationICollect: "1. Information I Collect",
    informationICollectText: "I collect information you provide directly to me, such as when you:",
    informationICollectItem1: "Fill out my contact form or request a consultation",
  ...
  nl: {
    ...
    philosophyTitle2: "Die Mij",
    philosophyTitle3: "Leiden",
    philosophyItemTitle1: "Doelgericht Ontwerp",
    philosophyDesc1: "Elk element heeft een doel. Ik creëer ontwerpen die niet alleen mooi zijn, maar strategisch gemaakt om jouw bedrijfsdoelen te bereiken.",
    ...
    processDesc1: "Ik duik diep in het begrijpen van jouw bedrijf, doelen en doelgroep om een strategische basis voor succes te creëren.",
    ...
    ctaTitle3: "Creëren?",
    ctaSubtitle: "Laat mij jouw visie transformeren tot een digitale realiteit die resultaten oplevert en blijvende impact creëert.",
    ...
    blogSubtitle: "Tips, trends en verhalen achter de schermen van mijn reis in webontwikkeling en ontwerp.",
    firstPostTitle: "Welkom bij Mijn Blog: Achter de Schermen van VirtualCreators",
    ...
    firstPostPara2: "De wereld van webontwikkeling beweegt ongelooflijk snel. Nieuwe technologieën ontstaan, ontwerp trends evolueren, en gebruikersverwachtingen blijven stijgen. Door deze blog wil ik niet alleen documenteren wat ik leer, maar ook hoe ik deze inzichten toepas op echte projecten.",
    firstPostHeading2: "Wat Je Kunt Verwachten",
    firstPostPara3: "Ik ga een mix van content delen die waardevol is, of je nu een collega-ontwikkelaar bent, een <a href=\"../../index.html#services\">bedrijfseigenaar die zijn digitale aanwezigheid wil verbeteren</a>, of gewoon iemand die nieuwsgierig is naar de webontwikkelingswereld.",
    ...
    firstPostHeading3: "Mijn Ontwikkelingsfilosofie",
    firstPostPara4: "Elk project waaraan ik werk wordt geleid door een eenvoudig principe: doordacht ontwerp en ontwikkeling moet zowel de gebruiker als het bedrijf dienen. Dit betekent oplossingen creëren die niet alleen visueel aantrekkelijk zijn, maar ook performant, toegankelijk en afgestemd op strategische doelen.",
    firstPostPara5: "Ik geloof in de kracht van eenvoud. De beste oplossingen komen vaak voort uit het diep begrijpen van het kernprobleem en het vinden van elegante manieren om het op te lossen. Deze benadering heeft me goed gediend in projecten variërend van e-commerce platforms tot community websites.",
    ...
    designTrendsPara3: "Ik heb deze benadering geïmplementeerd in recente <a href=\"../../index.html#work\">klantprojecten</a>, waar we conversie-verbeteringen tot 40% hebben behaald door simpelweg visuele ruis te verwijderen en te focussen op wat echt belangrijk is voor de gebruikersreis. Je kunt meer lezen over mijn <a href=\"my-first-post.html\">ontwerpfilosofie en benadering</a>.",
    ...
    informationICollect: "1. Informatie die ik verzamel",
    informationICollectText: "Ik verzamel informatie die je direct aan mij verstrekt, zoals wanneer je:",
    informationICollectItem1: "Mijn contactformulier invult of een consultatie aanvraagt",
