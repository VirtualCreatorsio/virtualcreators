...
const projects = [
  ...
  },
  {
    ...
    images: [
      { src: `${assetPathPrefix}assets/lumenix-project.webp`, alt: "TractionMovies Homepage" },
      { src: `${assetPathPrefix}assets/lumenix-project.webp`, alt: "TractionMovies Portfolio" },
    ],
  ...
  },
  {
    ...
    scrollVideo: null, // No scroll video for this project
    images: [
      { src: `${assetPathPrefix}assets/lumenix-project.webp`, alt: "LifeSciGrowth Homepage" },
      { src: `${assetPathPrefix}assets/lumenix-project.webp`, alt: "LifeSciGrowth Community" },
      { src: `${assetPathPrefix}assets/lumenix-project.webp`, alt: "LifeSciGrowth Courses" },
    ],
