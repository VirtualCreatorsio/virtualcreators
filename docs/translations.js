...
const translations = {
  en: {
    ...
    firstPostPara6: "In upcoming posts, we'll be diving deeper into specific projects, sharing code examples, and exploring the latest developments in web technology. We're particularly excited to write about the evolving landscape of web performance, the rise of modern CSS features, and <a href=\"ai-changing-design-development.html\">how AI is changing the way we approach development</a>.",
